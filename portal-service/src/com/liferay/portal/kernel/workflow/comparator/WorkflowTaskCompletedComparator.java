 ...
 * @author Inácio Nery
 */
public class WorkflowTaskCompletedComparator
	extends OrderByComparator<WorkflowTask> {

	public WorkflowTaskCompletedComparator(
	...
	public int compare(WorkflowTask workflowTask1, WorkflowTask workflowTask2) {
		Boolean complete1 = workflowTask1.isCompleted();
		Boolean complete2 = workflowTask2.isCompleted();

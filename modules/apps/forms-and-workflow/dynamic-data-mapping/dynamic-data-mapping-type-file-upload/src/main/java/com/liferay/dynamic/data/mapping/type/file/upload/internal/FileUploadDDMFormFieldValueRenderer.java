 ...
 * @author Renato Rego
 */
@Component(immediate = true, property = "ddm.form.field.type.name=file_upload")
public class FileUploadDDMFormFieldValueRenderer
	implements DDMFormFieldValueRenderer {

	@Override
	public String render(DDMFormFieldValue ddmFormFieldValue, Locale locale) {
		JSONArray optionsValuesJSONArray =
			_fileUploadDDMFormFieldValueAccessor.getValue(ddmFormFieldValue, locale);
	...
	@Reference
	protected FileUploadDDMFormFieldValueAccessor
		_fileUploadDDMFormFieldValueAccessor;

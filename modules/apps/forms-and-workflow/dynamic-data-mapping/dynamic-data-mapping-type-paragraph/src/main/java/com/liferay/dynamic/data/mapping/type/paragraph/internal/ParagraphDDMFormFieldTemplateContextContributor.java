...
public class ParagraphDDMFormFieldTemplateContextContributor
	...
	public Map<String, Object> getParameters(
		...
		parameters.put("text", getSanitizedText(ddmFormField));

		return parameters;
	}

	protected Object getSanitizedText(DDMFormField ddmFormField) {
		String text = (String)ddmFormField.getProperty("text");

		return _soyHTMLSanitizer.sanitize(text);
	}

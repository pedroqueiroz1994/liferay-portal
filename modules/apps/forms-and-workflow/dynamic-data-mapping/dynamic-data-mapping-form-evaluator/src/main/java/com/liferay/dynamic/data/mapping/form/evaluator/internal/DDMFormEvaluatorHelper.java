...
public class DDMFormEvaluatorHelper {
	...
	protected String getSelectValueString(String valueString) {
		try {
	...
	protected String getValueString(Value value, String type, Locale locale) {
		if (value == null) {
			return null;
		}
		...
		if ("select".equals(type)) {
			valueString = getSelectValueString(valueString);
		}
	...
	protected void setDDMExpressionVariables(
		...
		for (DDMFormFieldValue ddmFormFieldValue : ddmFormFieldValues) {
			...
			String valueString = getValueString(
				ddmFormFieldValue.getValue(), ddmFormField.getType(), _locale);

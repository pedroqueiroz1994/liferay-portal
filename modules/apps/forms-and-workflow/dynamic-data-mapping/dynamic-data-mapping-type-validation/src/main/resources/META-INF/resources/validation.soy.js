...
exports.render.params = ["enableValidationValue","errorMessagePlaceholder","errorMessageValue","name","parameterMessagePlaceholder","parameterValue","validationMessage","validationsOptions","value"];
exports.render.types = {"enableValidationValue":"bool","errorMessagePlaceholder":"string","errorMessageValue":"string","name":"string","parameterMessagePlaceholder":"string","parameterValue":"string","validationMessage":"string","validationsOptions":"list<[label: string, status: string, value: string]>","value":"?"};
templates = exports;
return exports;
